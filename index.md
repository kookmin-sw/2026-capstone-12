...
**CoreLight**는 오염의 근원인 **SpawnCore**가 정화 에너지를 흡수해 빛을 잃은 전장을 배경으로 하는 2인 협동 비대칭 멀티플레이 게임입니다.
...
최종 목표는 **CommandTower**를 지키며, 모든 **SpawnCore**를 파괴해 오염된 구역을 되돌리 것입니다.
...
| 이름 | 학번 | 담당 역할 | GitHub |
|---|---|---|---|
| 구자빈 | 20203028 | Shooter 플레이어, 게임 시스템, 적 AI, 오디오, 맵, 렌더링 | [@koojabin](https://github.com/koojabin) |
