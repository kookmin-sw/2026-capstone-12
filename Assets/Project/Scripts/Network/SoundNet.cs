...
public class SoundNet : MonoBehaviourPun
{
    ...
    private SoundPlaybackMode GetPlaybackMode(GameSoundType soundType)
    {
        return soundType switch
        {
            ...
            GameSoundType.ShooterWalk => SoundPlaybackMode.Network3D,
            GameSoundType.ShooterRun => SoundPlaybackMode.Network3D,
            GameSoundType.BuildStructure => SoundPlaybackMode.Network3D,
            GameSoundType.SupplyItem => SoundPlaybackMode.Network3D,
            GameSoundType.BasicFastEnemyGrowl => SoundPlaybackMode.Network3D,
            GameSoundType.TankEnemyGrowl => SoundPlaybackMode.Network3D,
            GameSoundType.StructureAttacked => SoundPlaybackMode.Network3D,
